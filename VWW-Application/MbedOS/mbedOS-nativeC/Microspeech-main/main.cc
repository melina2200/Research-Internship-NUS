...
//     int8_t TEMP_MATRIX[49*46];
//     int8_t PADDED_MATRIX[58*46];
...
int main() {
   ...
   // for(int i=0;i<100000;i++){
    ...
    //path_to_dir
    //   dir = opendir("/home/shivam/NUS/PACE/testing/Microspeech/test_data/");
    ...
    //     if(entry->d_type != DT_DIR) {
        ...
        //specify directory path here
        //   char full_file_name[] = "/home/yujie/MCU_stm32/linux_cortex-m7_default/prj/MicroSpeech_C_Code/Microspeech-main/test_data/test_data_id_1_label_2_.txt";
    ...
    //editted by yujie for space saving 
        // for (int i=0;i<R1; i++)
        // for (int j=0; j<500; j++){
        // 	OUTPUT_MATRIX[(i)*500+(j)] = OUTPUT_MATRIX_[(i)*C2+(j)];
        // }
    ...
    // t1.stop();
    // printf("Invoke time: %d\n", static_cast<int>(t1.read_high_resolution_us()));
    printf("Output Label:%d \n", obtained_label);
