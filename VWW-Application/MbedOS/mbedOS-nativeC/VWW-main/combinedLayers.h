void depthwise_conv_layer(int8_t* matrix,int8_t* weights, const int inp_channels, const int outp_channels, const int weight_dim, const int input_dim,
    int pad_l, int pad_r, int pad_u, int pad_d, int8_t pad_value, int32_t* bias, int32_t* multiply, int64_t* add, int8_t* shift, int stride)
{
    const int input_dim_new = input_dim/stride;
    int8_t INPUT_MATRIX[input_dim_new* input_dim_new* inp_channels* weight_dim* weight_dim];
    int32_t OUTPUT_MATRIX[input_dim_new* input_dim_new* inp_channels];
...
void complete_pointwise_conv_layer(int8_t* matrix,int8_t* weights, const int inp_channels, const int outp_channels , const int input_dim, 
    int32_t* bias, int32_t* multiply, int64_t* add, int8_t* shift)
    {
