...
// added by yujie for function invocation verification
                           ...
                           q7_t *output_data)
{
    ...
    for (i_batch = 0; i_batch < input_batches; i_batch++)
    {
        ...
        //added by yujie for test
        // printf("ARM_MATH_DSP \t");
        // int32_t order_im2col, order_mul=0;
        ...
        for (i_out_y = 0; i_out_y < output_y; i_out_y++)
        {
            for (i_out_x = 0; i_out_x < output_x; i_out_x++)
            {
                ...
                // printf("ARM_MATH_DSP --> arm_q7_to_q15_with_offset --> %d\n", order_im2col);
        ...
        // printf("arm_q7_to_q15_with_offset: %d; arm_nn_mat_mult_kernel_s8_s16: %d\n", order_im2col, order_mul);
